    ...
    public void testSomeWritersReleased() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            try {
                ...
                mayDrainWalQueue();
                try (TableWriterFrontend w = engine.getTableWriterFrontend(AllowAllCairoSecurityContext.INSTANCE, "weather", "testing")) {
//                    w.truncate();
                }
    ...
    public void testWriterInsertNewSymbolsIntoTableWithExistingSymbols() throws Exception {
        ...
        runInContext((receiver) -> {
            ...
            new Thread(() -> {
                try (TableWriterFrontend writer = engine.getTableWriterFrontend(AllowAllCairoSecurityContext.INSTANCE, tableName, "test")) {
